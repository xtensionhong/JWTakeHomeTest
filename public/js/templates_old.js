...
this["JST"]["templates/item.hbs"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id="
    ...
    + " class=\"jw-option\">\n	<div class=\"jw-thumbnail-container\" style=\"background-image: url('" + alias4(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"image","hash":{},"data":data}) : helper))) + "') \">\n 	<span class=\"list-menu \"></span>	<!--<img class=\"jw-thumbnail\" src=\""
